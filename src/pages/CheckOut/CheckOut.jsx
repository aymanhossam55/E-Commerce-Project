  ...
  return (
    <div>
      ...
      <div className="ms-12xl flex md:mx-0 sm:mx-0 md:flex-wrap-reverse sm:flex-wrap-reverse">
        <form action="post" className="w-6/12 md:w-full sm:w-full p-3 mt-xl me-2xl md:mx-6xl sm:mx-2xl">
          ...
          <div className="mb-2xl">
            ...
            <section className="flex justify-between px-l bg-[#f3f8f3] p-3 rounded-lg border border-dark-input">
              <p>Standard - 3 to 5 business days (Weekends and Holidays not included)</p>
              <p>E£79.00</p>
            </section>
          </div>
          ...
          <section className="flex flex-col px-l bg-[#f3f8f3] p-3 rounded-lg border border-dark-input">
            ...
            <div>
              <input
                ...
                placeholder="DiffrenceAddressShipping"
                name='address'
                className="border rounded-lg accent-dark-bg text-text-dark p-3 mb-4 h-4 w-4"
              />
          ...
          <div className='mt-xl'>
            <button className="bg-text-yellow text-white text-xl p-4 rounded-lg w-full hover:bg-yellow-500">Place Order</button>
          </div>
        </form>
